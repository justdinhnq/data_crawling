...
def func():
    """ 
        Hourly demand by balancing authority subregion. 
        Source: Form EIA-930 
    ...
    try:
        ...
        base_url = "https://api.eia.gov/v2/electricity/rto/region-sub-ba-data/data/?api_key={}&frequency=hourly&data[0]=value&sort[0][column]=period&sort[0][direction]=desc&offset=0&length=5000".format(api_key)
    ...
    if not df.empty:
        ...
        df.to_csv("./data/by_subregion.csv")
